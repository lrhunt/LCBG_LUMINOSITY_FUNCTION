...
#LCBGS2=np.where((M<=-18.5)&(SBe2<=21)&(Vegabv<0.6))[0]
#LCBGS3=np.where((M<=-18.5)&(SBe3<=21)&(Vegabv<0.6))[0]
...
for i in range(0,len(carr)):
	upperlim=22.5-imag[i]+cosmo.distmod(zbest[i]).value-2.5*np.log10(rmarr[i][5])
	lowerlim=15-imag[i]+cosmo.distmod(zbest[i]).value-2.5*np.log10(rmarr[i][5])
...
#TO PLOT RANDOM SUBSET OF GALAXIES

SBy=np.linspace(16,21,30)
SBx=np.full_like(SBy,0.6)
bvx=np.linspace(-.5,.6,30)
bvy=np.full_like(bvx,22)

randLCBGS=np.random.random(100)
randLCBGS=randLCBGS*len(LCBGS)
randLCBGS=randLCBGS.astype(int)

randGALS=np.random.random(1000)
randGALS=randGALS*len(Vegabv)
randGALS=randGALS.astype(int)

plt.plot(Vegabv[randGALS],VegaSBe[randGALS],'.',markersize=5)
plt.plot(Vegabv[LCBGS[randLCBGS]],VegaSBe[LCBGS[randLCBGS]],'*')
plt.plot(bvx,bvy,'r--')
plt.plot(SBx,SBy,'r--')
plt.ylim(27,15)
plt.xlim(-0.5,1.5)
...
plt.plot(Vegabv,VegaSBe,'.',markersize=5)
plt.plot(Vegabv[LCBGS],VegaSBe[LCBGS],'*')
plt.plot(bvx,bvy,'r--')
plt.plot(SBx,SBy,'r--')
plt.ylim(27,15)
plt.xlim(-0.5,1.5)
...
axes[0][0].plot(Vegabv[np.where((zbest>0.01)&(zbest<0.25)&(Vegaub>-0.032*(M+21.52)+0.304))[0]],VegaSBe[np.where((zbest>0.01)&(zbest<0.25)&(Vegaub>-0.032*(M+21.52)+0.304))[0]],'.',markersize=2,color='red',label='0.1<z<0.35')
axes[0][0].plot(Vegabv[np.where((zbest>0.01)&(zbest<0.25)&(Vegaub<-0.032*(M+21.52)+0.104))[0]],VegaSBe[np.where((zbest>0.01)&(zbest<0.25)&(Vegaub<-0.032*(M+21.52)+0.104))[0]],'.',markersize=2,color='blue',label='0.1<z<0.35')
axes[0][0].plot(Vegabv[np.where((zbest>0.01)&(zbest<0.25)&(Vegaub>-0.032*(M+21.52)+0.104)&(Vegaub<-0.032*(M+21.52)+0.304))[0]],VegaSBe[np.where((zbest>0.01)&(zbest<0.25)&(Vegaub>-0.032*(M+21.52)+0.104)&(Vegaub<-0.032*(M+21.52)+0.304))[0]],'.',markersize=2,color='green',label='0.1<z<0.35')
axes[0][0].plot(Vegabv[LCBGS[np.where((zbest[LCBGS]>0.01)&(zbest[LCBGS]<0.25))[0]]],VegaSBe[LCBGS[np.where((zbest[LCBGS]>0.01)&(zbest[LCBGS]<0.25))[0]]],marker='o',linestyle='none',markeredgecolor='blue',mfc='none',markersize=3,mew=0.1)
...
axes[0][0].fill_between(bvx,21,16,facecolor='blue',alpha=0.3)
axes[0][0].text(0,25,'z=0.01-0.25',verticalalignment='center',fontsize=10)


axes[0][1].plot(Vegabv[np.where((zbest>0.25)&(zbest<0.5)&(Vegaub>-0.032*(M+21.52)+0.304))[0]],VegaSBe[np.where((zbest>0.25)&(zbest<0.5)&(Vegaub>-0.032*(M+21.52)+0.304))[0]],'.',markersize=2,color='red',label='0.1<z<0.55')
axes[0][1].plot(Vegabv[np.where((zbest>0.25)&(zbest<0.5)&(Vegaub<-0.032*(M+21.52)+0.104))[0]],VegaSBe[np.where((zbest>0.25)&(zbest<0.5)&(Vegaub<-0.032*(M+21.52)+0.104))[0]],'.',markersize=2,color='blue',label='0.1<z<0.55')
axes[0][1].plot(Vegabv[np.where((zbest>0.25)&(zbest<0.5)&(Vegaub>-0.032*(M+21.52)+0.104)&(Vegaub<-0.032*(M+21.52)+0.304))[0]],VegaSBe[np.where((zbest>0.25)&(zbest<0.5)&(Vegaub>-0.032*(M+21.52)+0.104)&(Vegaub<-0.032*(M+21.52)+0.304))[0]],'.',markersize=2,color='green',label='0.1<z<0.55')
axes[0][1].plot(Vegabv[LCBGS[np.where((zbest[LCBGS]>0.25)&(zbest[LCBGS]<0.5))[0]]],VegaSBe[LCBGS[np.where((zbest[LCBGS]>0.25)&(zbest[LCBGS]<0.5))[0]]],marker='o',linestyle='none',markeredgecolor='blue',mfc='none',markersize=3,mew=0.1)
plt.subplots_adjust(hspace=0,wspace=0)
axes[0][1].plot(bvx,bvy,'b')
axes[0][1].plot(SBx,SBy,'b')
axes[0][1].fill_between(bvx,21,16,facecolor='blue',alpha=0.3)
axes[0][1].text(0,25,'z=0.25-0.50',verticalalignment='center',fontsize=10)

axes[1][0].plot(Vegabv[np.where((zbest>0.5)&(zbest<0.75)&(Vegaub>-0.032*(M+21.52)+0.304))[0]],VegaSBe[np.where((zbest>0.5)&(zbest<0.75)&(Vegaub>-0.032*(M+21.52)+0.304))[0]],'.',markersize=2,color='red',label='0.1<z<0.75')
axes[1][0].plot(Vegabv[np.where((zbest>0.5)&(zbest<0.75)&(Vegaub<-0.032*(M+21.52)+0.104))[0]],VegaSBe[np.where((zbest>0.5)&(zbest<0.75)&(Vegaub<-0.032*(M+21.52)+0.104))[0]],'.',markersize=2,color='blue',label='0.1<z<0.75')
axes[1][0].plot(Vegabv[np.where((zbest>0.5)&(zbest<0.75)&(Vegaub>-0.032*(M+21.52)+0.104)&(Vegaub<-0.032*(M+21.52)+0.304))[0]],VegaSBe[np.where((zbest>0.5)&(zbest<0.75)&(Vegaub>-0.032*(M+21.52)+0.104)&(Vegaub<-0.032*(M+21.52)+0.304))[0]],'.',markersize=2,color='green',label='0.1<z<0.75')
axes[1][0].plot(Vegabv[LCBGS[np.where((zbest[LCBGS]>0.5)&(zbest[LCBGS]<0.75))[0]]],VegaSBe[LCBGS[np.where((zbest[LCBGS]>0.5)&(zbest[LCBGS]<0.75))[0]]],marker='o',linestyle='none',markeredgecolor='blue',mfc='none',markersize=3,mew=0.1)
axes[1][0].plot(bvx,bvy,'b')
axes[1][0].plot(SBx,SBy,'b')
axes[1][0].fill_between(bvx,21,16,facecolor='blue',alpha=0.3)
axes[1][0].text(0,25,'z=0.50-0.75',verticalalignment='center',fontsize=10)


axes[1][1].plot(Vegabv[np.where((zbest>0.75)&(zbest<1)&(Vegaub>-0.032*(M+21.52)+0.304))[0]],VegaSBe[np.where((zbest>0.75)&(zbest<1)&(Vegaub>-0.032*(M+21.52)+0.304))[0]],'.',markersize=2,color='red',label='0.1<z<1')
axes[1][1].plot(Vegabv[np.where((zbest>0.75)&(zbest<1)&(Vegaub<-0.032*(M+21.52)+0.104))[0]],VegaSBe[np.where((zbest>0.75)&(zbest<1)&(Vegaub<-0.032*(M+21.52)+0.104))[0]],'.',markersize=2,color='blue',label='0.1<z<1')
axes[1][1].plot(Vegabv[np.where((zbest>0.75)&(zbest<1)&(Vegaub>-0.032*(M+21.52)+0.104)&(Vegaub<-0.032*(M+21.52)+0.304))[0]],VegaSBe[np.where((zbest>0.75)&(zbest<1)&(Vegaub>-0.032*(M+21.52)+0.104)&(Vegaub<-0.032*(M+21.52)+0.304))[0]],'.',markersize=2,color='green',label='0.1<z<1')
axes[1][1].plot(Vegabv[LCBGS[np.where((zbest[LCBGS]>0.75)&(zbest[LCBGS]<1))[0]]],VegaSBe[LCBGS[np.where((zbest[LCBGS]>0.75)&(zbest[LCBGS]<1))[0]]],marker='o',linestyle='none',markeredgecolor='blue',mfc='none',markersize=3,mew=0.1)
axes[1][1].plot(bvx,bvy,'b')
axes[1][1].plot(SBx,SBy,'b')
axes[1][1].fill_between(bvx,21,16,facecolor='blue',alpha=0.3)
axes[1][1].text(0,25,'z=0.75-1.0',verticalalignment='center',fontsize=10,)
f.text(0.07,0.65,'$\mu_{e}$(B)$_{0}$',ha='center',va='center',rotation='vertical')
f.text(0.52,0.05,'(B-V)$_{0}$',ha='center',va='center')
...
f,axes=plt.subplots(nrows=3,ncols=1,sharex=True,sharey=True,gridspec_kw={'height_ratios':[1,1,1]})
...
axes[0].text(0.1,0.6,'N$_{LCBG}$/N$_{GAL}$ COSMOS',va='center')
axes[1].text(0.1,0.6,'$\phi_{LCBG}$/$\phi_{GAL,M=-18.5}$',va='center')
axes[2].text(0.1,0.6,'$\phi_{LCBG}$/$\phi_{GAL,M=-15}$',va='center')

axes[0].errorbar(0.7,guzman,yerr=guzmanerror,xerr=0.3,label='Guzm$\`{a}$n results')
axes[1].errorbar(0.7,guzman,yerr=guzmanerror,xerr=0.3,label='Guzm$\`{a}$n results')
axes[2].errorbar(0.7,guzman,yerr=guzmanerror,xerr=0.3,label='Guzm$\`{a}$n results')
