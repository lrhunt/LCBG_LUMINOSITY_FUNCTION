...
for magrange in Magnitude_Loop_Array:
    Num_Good_Spec=len(CATALOG[(CATALOG.Ks_MAG_AUTO>magrange[0])&
                              (CATALOG.Ks_MAG_AUTO<magrange[1])&
                              (CATALOG.TYPE==0)&
                              (CATALOG.final_use==1)])
    Num_Bad_Spec=len(CATALOG[(CATALOG.Ks_MAG_AUTO>magrange[0])&
                             (CATALOG.Ks_MAG_AUTO<magrange[1])&
                             (CATALOG.TYPE==0)&
                             (CATALOG.final_use==2)])
    Num_Good_Color=len(CATALOG[(CATALOG.Ks_MAG_AUTO>magrange[0])&
                               (CATALOG.Ks_MAG_AUTO<magrange[1])&
                               (CATALOG.TYPE==0)&
                               ((CATALOG.B_MAG_AUTO<80)&
                                (CATALOG.V_MAG_AUTO<80))])
    Num_Bad_Color=len(CATALOG[(CATALOG.Ks_MAG_AUTO>magrange[0])&
                              (CATALOG.Ks_MAG_AUTO<magrange[1])&
                              (CATALOG.TYPE==0)&
                              ((CATALOG.B_MAG_AUTO>80)|
                                (CATALOG.V_MAG_AUTO>80))])
    Num_Bad_Rh=len(CATALOG[(CATALOG.Ks_MAG_AUTO>magrange[0])&
                           (CATALOG.Ks_MAG_AUTO<magrange[1])&
                           (CATALOG.TYPE==0)&
                           (CATALOG.FLUX_RADIUS<0)])
    Num_Good_Rh=len(CATALOG[(CATALOG.Ks_MAG_AUTO>magrange[0])&
                            (CATALOG.Ks_MAG_AUTO<magrange[1])&
                            (CATALOG.TYPE==0)&
                            (CATALOG.FLUX_RADIUS>0)])
    CATALOG.loc[(CATALOG.Ks_MAG_AUTO>magrange[0])&
                (CATALOG.Ks_MAG_AUTO<magrange[1])&
                (CATALOG.TYPE==0),
...
if args.LCBGLIST:
    LUMFUNC_CATALOG=CATALOG[(CATALOG.final_use==1)&(CATALOG.Ks_MAG_AUTO<=args.appmax)&(CATALOG.Ks_MAG_AUTO>=args.appmin)&(CATALOG.TYPE==0)&(CATALOG.final_z>=args.zmin)&(CATALOG.final_z<=args.zmax)&(CATALOG.is_LCBG==1)]
else:
    LUMFUNC_CATALOG=CATALOG[(CATALOG.final_use==1)&(CATALOG.Ks_MAG_AUTO<=args.appmax)&(CATALOG.Ks_MAG_AUTO>=args.appmin)&(CATALOG.TYPE==0)&(CATALOG.final_z>=args.zmin)&(CATALOG.final_z<=args.zmax)]
...
for x in LUMFUNC_CATALOG.index:
    ...
    AbsMag=LUMFUNC_CATALOG.ip_MAG_AUTO.loc[x]-cosmo.distmod(LUMFUNC_CATALOG.final_z.loc[x]).value-LUMFUNC_CATALOG.ip_synthetic_mag.loc[x]-2.5*np.log10(rmarrlookup[0])
...
for rng in Abs_Magnitude_Loop_Array:
    if args.LCBGLIST:
        NUMB_DENS_LIST.append(((LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Spec_Weight']*LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Color_Weight']*LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Surface_Brightness_Weight'])/(LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'comoving_volume']*mbinsize)).sum())
        AveWeight.append((LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Spec_Weight']*LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Color_Weight']*LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Surface_Brightness_Weight']).sum()/len(LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Spec_Weight']))
        NUMB_DENS_Err.append(np.sqrt(((LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Spec_Weight']*LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Color_Weight']*LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Surface_Brightness_Weight'])/(LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'comoving_volume']*mbinsize)**2).sum()))
    else:
        NUMB_DENS_LIST.append((LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Spec_Weight']/(LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'comoving_volume']*mbinsize)).sum())
        NUMB_DENS_Err.append(np.sqrt((LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Spec_Weight']/(LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'comoving_volume']*mbinsize)**2).sum()))
        AveWeight.append(LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Spec_Weight'].sum()/len(LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Spec_Weight']))
    NGal.append(len(LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Spec_Weight']))
    AveCMV.append(LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'comoving_volume'].sum()/len(LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'Spec_Weight']))
    Abs_Mags.append(LUMFUNC_CATALOG.loc[(LUMFUNC_CATALOG.BJ0_vega_absmag>rng[0])&(LUMFUNC_CATALOG.BJ0_vega_absmag<rng[1]),'BJ0_vega_absmag'].mean())
