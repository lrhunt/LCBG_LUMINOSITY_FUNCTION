...
sfilein='/home/lrhunt/LUM_FUNC/LF_ZUCCA_10_35.txt'
...
axes[0].plot(LCBG_Range,np.log10(LUMFUNC_ZUCCA_FIT1035(LCBG_Range)),color='blue')
axes[0].plot(LCBG_Range,np.log10(LUMFUNC_ZUCCA_FIT1035z(LCBG_Range)),color='black')
autolabel(gals,'black')
...
sfilein='/home/lrhunt/LUM_FUNC/LF_ZUCCA_35_55.txt'
...
f,axes=plt.subplots(nrows=2,ncols=1,sharex=True,gridspec_kw={'height_ratios':[3,1]})
code=axes[0].errorbar(MBINAVE,np.log10(LumFunc),yerr=LogErr,fmt=',',label='1/V$_{MAX}$ code',color='blue')
code=axes[0].errorbar(MBINAVEz,LogLumFuncz,yerr=LogErrzdown,fmt=',',label='1/V$_{MAX}$ code',color='black')
gals=axes[1].bar(MBinMid,np.log10(NGal),Mbinsize,align='center',label='Number of Galaxies per Absolute Magnitude Bin',color='white')
axes[0].plot(LCBG_Range,np.log10(LUMFUNC_ZUCCA_FIT3555(LCBG_Range)),color='blue')
axes[0].plot(LCBG_Range,np.log10(LUMFUNC_ZUCCA_FIT3555z(LCBG_Range)),color='black')
autolabel(gals,'black')
...
sfilein='/home/lrhunt/LUM_FUNC/LF_ZUCCA_55_75.txt'
...
code=axes[0].errorbar(MBINAVE,np.log10(LumFunc),yerr=LogErr,fmt=',',label='1/V$_{MAX}$ code')
gals=axes[1].bar(MBinMid,np.log10(NGal),Mbinsize,align='center',label='Number of Galaxies per Absolute Magnitude Bin',color='white')
axes[0].plot(LCBG_Range,np.log10(LUMFUNC_ZUCCA_FIT5575(LCBG_Range)))
autolabel(gals,'black')
...
sfilein='/home/lrhunt/LUM_FUNC/LF_ZUCCA_75_100.txt'
...
code=axes[0].errorbar(MBINAVE,np.log10(LumFunc),yerr=LogErr,fmt=',',label='1/V$_{MAX}$ code')
gals=axes[1].bar(MBinMid,np.log10(NGal),Mbinsize,align='center',label='Number of Galaxies per Absolute Magnitude Bin',color='white')
axes[0].plot(LCBG_Range,np.log10(LUMFUNC_ZUCCA_FIT75100(LCBG_Range)))
autolabel(gals,'black')
...
sfilein='/home/lrhunt/LUM_FUNC/LF_ZUCCA_30_80.txt'
...
code=axes[0].errorbar(MBINAVEz,LogLumFuncz,yerr=LogErrzdown,fmt=',',label='1/V$_{MAX}$ code',color='black')
gals=axes[1].bar(MBinMid,np.log10(NGal),Mbinsize,align='center',label='Number of Galaxies per Absolute Magnitude Bin',color='white')
axes[0].plot(LCBG_Range,np.log10(LUMFUNC_ZUCCA_FIT3080(LCBG_Range)),color='blue')
axes[0].plot(LCBG_Range,np.log10(LUMFUNC_ZUCCA_FIT3080z(LCBG_Range)),color='black')
autolabel(gals,'black')
