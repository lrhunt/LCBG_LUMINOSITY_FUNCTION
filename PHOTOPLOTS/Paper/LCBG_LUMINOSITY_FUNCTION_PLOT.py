#Edits to plot Luminosity Function by hand. Must edit file name for various sources
import numpy as np
...
filein='/home/lrhunt/LUM_FUNC/LCBG_LF_0_20.txt'
sfilein='/home/lrhunt/LUM_FUNC/LF_0_20_FULL.txt'
...
#filein='/home/lrhunt/LUM_FUNC/LCBG_LF_0_20_2.txt'
#sfilein='/home/lrhunt/LUM_FUNC/LF_0_20_VOL_LIMIT.txt'
#LMBinMidVOL,LMBINAVEVOL,LLumFuncVOL,LLumFuncErrVOL,LLogErrVOL,LNGalVOL,LAveCMVVOL,LAveWeightVOL=np.loadtxt(filein,unpack=True,skiprows=1)
##MBinMidVOL,MBINAVEVOL,LumFuncVOL,LumFuncErrVOL,LogErrVOL,NGalVOL,AveCMVVOL,AveWeightVOL=np.loadtxt(sfilein,unpack=True,skiprows=1)
#with open(filein,'r') as lf:
#    lspecvals=lf.readline().strip().split()
#with open(sfilein,'r') as lf:
#	specvals=lf.readline().strip().split()
#lzmaxVOL=float(lspecvals[1])
###lzminVOL=float(lspecvals[2])
#lmbinVOL=float(lspecvals[3])
#lMbinsizeVOL=float(lspecvals[4])
#zmaxVOL=float(specvals[1])
#zminVOL=float(specvals[2])
#mbinVOL=float(specvals[3])
#MbinsizeVOL=float(specvals[4])
#fit=LevMarLSQFitter()

#LLumFunc2=np.ma.array(LLumFuncVOL,mask=False)
###LMBINAVE2=np.ma.array(LMBINAVEVOL,mask=False)
#LLumFuncErr2=np.ma.array(LLumFuncErrVOL,mask=False)
#LumFunc2=np.ma.array(LumFuncVOL,mask=False)
#MBINAVE2=np.ma.array(MBINAVEVOL,mask=False)
#LumFuncErr2=np.ma.array(LumFuncErrVOL,mask=False)
##LLumFunc2.mask[np.where(LLumFunc2==0)[0]]=True
#LMBINAVE2.mask[np.where(LLumFunc2==0)[0]]=True
#LLumFuncErr2.mask[np.where(LLumFunc2==0)[0]]=True
#LumFunc2.mask[np.where(LumFunc2==0)[0]]=True
#MBINAVE2.mask[np.where(LumFunc2==0)[0]]=True
#LumFuncErr2.mask[np.where(LumFunc2==0)[0]]=True
###LCBG_FIT020_VOL=fit(LCBGFIT_init,LMBINAVE2.compressed(),LLumFunc2.compressed(),weights=1/LLumFuncErr2.compressed())
##LUMFUNC_FIT020_VOL=fit(LCBGFIT_init,MBINAVE2.compressed(),LumFunc2.compressed(),weights=1/LumFuncErr2.compressed())
#f,axes=plt.subplots(nrows=2,ncols=1,sharex=True,gridspec_kw={'height_ratios':[3,1]})
#LCBGcode=axes[0].errorbar(LMBINAVE,np.log10(LLumFunc),yerr=LLogErr,fmt=',',color='gray',label='1/V$_{MAX}$ code')
#code=axes[0].errorbar(MBINAVE,np.log10(LumFunc),yerr=LogErr,fmt=',',color='black',label='1/V$_{MAX}$ code')
##LCBGcode=axes[0].errorbar(LMBINAVEVOL,np.log10(LLumFuncVOL),yerr=LLogErrVOL,fmt='.',color='blue',label='1/V$_{MAX}$ code')
#code=axes[0].errorbar(MBINAVEVOL,np.log10(LumFuncVOL),yerr=LogErrVOL,fmt='.',color='red',label='1/V$_{MAX}$ code')
##gals=axes[1].bar(MBinMidVOL,np.log10(NGalVOL),MbinsizeVOL,align='center',label='Number of Galaxies per Absolute Magnitude Bin',color='white')
#lcbg=axes[1].bar(LMBinMidVOL,np.log10(LNGalVOL),lMbinsizeVOL,align='center',label='Number of LCBGs per Absolute Magnitude Bin',color='gray')
#axes[0].plot(LCBG_Range,np.log10(LCBG_FIT020_VOL(LCBG_Range)),color='blue')
#axes[0].plot(LCBG_Range,np.log10(LUMFUNC_FIT020_VOL(LCBG_Range)),color='red')
#axes[0].plot(LCBG_Range,np.log10(LCBG_FIT020(LCBG_Range)),color='gray')
#axes[0].plot(LCBG_Range,np.log10(LUMFUNC_FIT020(LCBG_Range)),color='black')
...
filein='/home/lrhunt/LUM_FUNC/LCBG_LF_20_40.txt'
sfilein='/home/lrhunt/LUM_FUNC/LF_20_40_FULL.txt'
...
#filein='/home/lrhunt/LUM_FUNC/LCBG_LF_20_40_2.txt'
#sfilein='/home/lrhunt/LUM_FUNC/LF_20_40_VOL_LIMIT.txt'
#LMBinMidVOL,LMBINAVEVOL,LLumFuncVOL,LLumFuncErrVOL,LLogErrVOL,LNGalVOL,LAveCMVVOL,LAveWeightVOL=np.loadtxt(filein,unpack=True,skiprows=1)
#MBinMidVOL,MBINAVEVOL,LumFuncVOL,LumFuncErrVOL,LogErrVOL,NGalVOL,AveCMVVOL,AveWeightVOL=np.loadtxt(sfilein,unpack=True,skiprows=1)
#with open(filein,'r') as lf:
#    lspecvals=lf.readline().strip().split()
...
#MBINAVE2.mask[np.where(LumFunc2==0)[0]]=True
#LumFuncErr2.mask[np.where(LumFunc2==0)[0]]=True
#LCBG_FIT2040_VOL=fit(LCBGFIT_init,LMBINAVE2.compressed(),LLumFunc2.compressed(),weights=1/LLumFuncErr2.compressed())
#LUMFUNC_FIT2040_VOL=fit(LCBGFIT_init,MBINAVE2.compressed(),LumFunc2.compressed(),weights=1/LumFuncErr2.compressed())
####f,axes=plt.subplots(nrows=2,ncols=1,sharex=True,gridspec_kw={'height_ratios':[3,1]})
#LCBGcode=axes[0].errorbar(LMBINAVE,np.log10(LLumFunc),yerr=LLogErr,fmt=',',color='gray',label='1/V$_{MAX}$ code')
#code=axes[0].errorbar(MBINAVE,np.log10(LumFunc),yerr=LogErr,fmt=',',color='black',label='1/V$_{MAX}$ code')
#LCBGcode=axes[0].errorbar(LMBINAVEVOL,np.log10(LLumFuncVOL),yerr=LLogErrVOL,fmt='.',color='blue',label='1/V$_{MAX}$ code')
...
##gals=axes[1].bar(MBinMidVOL,np.log10(NGalVOL),MbinsizeVOL,align='center',label='Number of Galaxies per Absolute Magnitude Bin',color='white')
#lcbg=axes[1].bar(LMBinMidVOL,np.log10(LNGalVOL),lMbinsizeVOL,align='center',label='Number of LCBGs per Absolute Magnitude Bin',color='gray')
#axes[0].plot(LCBG_Range,np.log10(LCBG_FIT2040_VOL(LCBG_Range)),color='blue')
#axes[0].plot(LCBG_Range,np.log10(LUMFUNC_FIT2040_VOL(LCBG_Range)),color='red')
#axes[0].plot(LCBG_Range,np.log10(LCBG_FIT2040(LCBG_Range)),color='gray')
#axes[0].plot(LCBG_Range,np.log10(LUMFUNC_FIT2040(LCBG_Range)),color='black')
#autolabel(lcbg,'black')
#autolabel(gals,'black')
...
#New Files
filein='/home/lrhunt/LUM_FUNC/LCBG_LF_40_60.txt'
sfilein='/home/lrhunt/LUM_FUNC/LF_40_60_FULL.txt'
...
#filein='/home/lrhunt/LUM_FUNC/LCBG_LF_40_60_2.txt'
#sfilein='/home/lrhunt/LUM_FUNC/LF_40_60_VOL_LIMIT.txt'
##LMBinMidVOL,LMBINAVEVOL,LLumFuncVOL,LLumFuncErrVOL,LLogErrVOL,LNGalVOL,LAveCMVVOL,LAveWeightVOL=np.loadtxt(filein,unpack=True,skiprows=1)
#MBinMidVOL,MBINAVEVOL,LumFuncVOL,LumFuncErrVOL,LogErrVOL,NGalVOL,AveCMVVOL,AveWeightVOL=np.loadtxt(sfilein,unpack=True,skiprows=1)
#with open(filein,'r') as lf:
#    lspecvals=lf.readline().strip().split()
...
#gals=axes[1].bar(MBinMidVOL,np.log10(NGalVOL),MbinsizeVOL,align='center',label='Number of Galaxies per Absolute Magnitude Bin',color='white')
#lcbg=axes[1].bar(LMBinMidVOL,np.log10(LNGalVOL),lMbinsizeVOL,align='center',label='Number of LCBGs per Absolute Magnitude Bin',color='gray')
#axes[0].plot(LCBG_Range,np.log10(LCBG_FIT4060_VOL(LCBG_Range)),color='blue')
#axes[0].plot(LCBG_Range,np.log10(LUMFUNC_FIT4060_VOL(LCBG_Range)),color='red')
#axes[0].plot(LCBG_Range,np.log10(LCBG_FIT4060(LCBG_Range)),color='gray')
#axes[0].plot(LCBG_Range,np.log10(LUMFUNC_FIT4060(LCBG_Range)),color='black')
#autolabel(lcbg,'black')
#autolabel(gals,'black')

#PLOTTING 0.6<z<0.8

filein='/home/lrhunt/LUM_FUNC/LCBG_LF_60_80.txt'
sfilein='/home/lrhunt/LUM_FUNC/LF_60_80_FULL.txt'
...
##filein='/home/lrhunt/LUM_FUNC/LCBG_LF_60_80_2.txt'
#sfilein='/home/lrhunt/LUM_FUNC/LF_60_80_VOL_LIMIT.txt'
#LMBinMidVOL,LMBINAVEVOL,LLumFuncVOL,LLumFuncErrVOL,LLogErrVOL,LNGalVOL,LAveCMVVOL,LAveWeightVOL=np.loadtxt(filein,unpack=True,skiprows=1)
#MBinMidVOL,MBINAVEVOL,LumFuncVOL,LumFuncErrVOL,LogErrVOL,NGalVOL,AveCMVVOL,AveWeightVOL=np.loadtxt(sfilein,unpack=True,skiprows=1)
#with open(filein,'r') as lf:
#    lspecvals=lf.readline().strip().split()
...
#MBINAVE2.mask[np.where(LumFunc2==0)[0]]=True
#LumFuncErr2.mask[np.where(LumFunc2==0)[0]]=True
##LCBG_FIT6080_VOL=fit(LCBGFIT_init,LMBINAVE2.compressed(),LLumFunc2.compressed(),weights=1/LLumFuncErr2.compressed())
#LUMFUNC_FIT6080_VOL=fit(LCBGFIT_init,MBINAVE2.compressed(),LumFunc2.compressed(),weights=1/LumFuncErr2.compressed())
#f,axes=plt.subplots(nrows=2,ncols=1,sharex=True,gridspec_kw={'height_ratios':[3,1]})
#LCBGcode=axes[0].errorbar(LMBINAVE,np.log10(LLumFunc),yerr=LLogErr,fmt=',',color='gray',label='1/V$_{MAX}$ code')
#code=axes[0].errorbar(MBINAVE,np.log10(LumFunc),yerr=LogErr,fmt=',',color='black',label='1/V$_{MAX}$ code')
#LCBGcode=axes[0].errorbar(LMBINAVEVOL,np.log10(LLumFuncVOL),yerr=LLogErrVOL,fmt='.',color='blue',label='1/V$_{MAX}$ code')
...
#gals=axes[1].bar(MBinMidVOL,np.log10(NGalVOL),MbinsizeVOL,align='center',label='Number of Galaxies per Absolute Magnitude Bin',color='white')
#lcbg=axes[1].bar(LMBinMidVOL,np.log10(LNGalVOL),lMbinsizeVOL,align='center',label='Number of LCBGs per Absolute Magnitude Bin',color='gray')
#axes[0].plot(LCBG_Range,np.log10(LCBG_FIT6080_VOL(LCBG_Range)),color='blue')
#axes[0].plot(LCBG_Range,np.log10(LUMFUNC_FIT6080_VOL(LCBG_Range)),color='red')
#axes[0].plot(LCBG_Range,np.log10(LCBG_FIT6080(LCBG_Range)),color='gray')
#axes[0].plot(LCBG_Range,np.log10(LUMFUNC_FIT6080(LCBG_Range)),color='black')
#autolabel(lcbg,'black')
#autolabel(gals,'black')

#PLOTTING 0.8<z<1

filein='/home/lrhunt/LUM_FUNC/LCBG_LF_80_100.txt'
sfilein='/home/lrhunt/LUM_FUNC/LF_80_100_FULL.txt'
LMBinMid,LMBINAVE,LLumFunc,LLumFuncErr,LLogErr,LNGal,LAveCMV,LAveWeight=np.loadtxt(filein,unpack=True,skiprows=1)
MBinMid,MBINAVE,LumFunc,LumFuncErr,LogErr,NGal,AveCMV,AveWeight=np.loadtxt(sfilein,unpack=True,skiprows=1)
with open(filein,'r') as lf:
    lspecvals=lf.readline().strip().split()
...
#filein='/home/lrhunt/LUM_FUNC/LCBG_LF_80_100_2.txt'
#sfilein='/home/lrhunt/LUM_FUNC/LF_80_100_VOL_LIMIT.txt'
#LMBinMidVOL,LMBINAVEVOL,LLumFuncVOL,LLumFuncErrVOL,LLogErrVOL,LNGalVOL,LAveCMVVOL,LAveWeightVOL=np.loadtxt(filein,unpack=True,skiprows=1)
#MBinMidVOL,MBINAVEVOL,LumFuncVOL,LumFuncErrVOL,LogErrVOL,NGalVOL,AveCMVVOL,AveWeightVOL=np.loadtxt(sfilein,unpack=True,skiprows=1)
#with open(filein,'r') as lf:
#    lspecvals=lf.readline().strip().split()
...
#MBINAVE2.mask[np.where(LumFunc2==0)[0]]=True
#LumFuncErr2.mask[np.where(LumFunc2==0)[0]]=True
#LCBG_FIT80100_VOL=fit(LCBGFIT_init,LMBINAVE2.compressed(),LLumFunc2.compressed(),weights=1/LLumFuncErr2.compressed())
#LUMFUNC_FIT80100_VOL=fit(LCBGFIT_init,MBINAVE2.compressed(),LumFunc2.compressed(),weights=1/LumFuncErr2.compressed())
#f,axes=plt.subplots(nrows=2,ncols=1,sharex=True,gridspec_kw={'height_ratios':[3,1]})
#LCBGcode=axes[0].errorbar(LMBINAVE,np.log10(LLumFunc),yerr=LLogErr,fmt=',',color='gray',label='1/V$_{MAX}$ code')
#code=axes[0].errorbar(MBINAVE,np.log10(LumFunc),yerr=LogErr,fmt=',',color='black',label='1/V$_{MAX}$ code')
#LCBGcode=axes[0].errorbar(LMBINAVEVOL,np.log10(LLumFuncVOL),yerr=LLogErrVOL,fmt='.',color='blue',label='1/V$_{MAX}$ code')
...
#gals=axes[1].bar(MBinMidVOL,np.log10(NGalVOL),MbinsizeVOL,align='center',label='Number of Galaxies per Absolute Magnitude Bin',color='white')
#lcbg=axes[1].bar(LMBinMidVOL,np.log10(LNGalVOL),lMbinsizeVOL,align='center',label='Number of LCBGs per Absolute Magnitude Bin',color='gray')
#axes[0].plot(LCBG_Range,np.log10(LCBG_FIT80100_VOL(LCBG_Range)),color='blue')
##axes[0].plot(LCBG_Range,np.log10(LUMFUNC_FIT80100_VOL(LCBG_Range)),color='red')
#axes[0].plot(LCBG_Range,np.log10(LCBG_FIT80100(LCBG_Range)),color='gray')
#axes[0].plot(LCBG_Range,np.log10(LUMFUNC_FIT80100(LCBG_Range)),color='black')
#autolabel(lcbg,'black')
#autolabel(gals,'black')

#0.3<z<0.8

filein='/home/lrhunt/LUM_FUNC/LCBG_LF_30_80.txt'
sfilein='/home/lrhunt/LUM_FUNC/LF_30_80_FULL.txt'
LMBinMid,LMBINAVE,LLumFunc,LLumFuncErr,LLogErr,LNGal,LAveCMV,LAveWeight=np.loadtxt(filein,unpack=True,skiprows=1)
MBinMid,MBINAVE,LumFunc,LumFuncErr,LogErr,NGal,AveCMV,AveWeight=np.loadtxt(sfilein,unpack=True,skiprows=1)
with open(filein,'r') as lf:
    lspecvals=lf.readline().strip().split()
...
#MBINAVE2.mask[np.where(LumFunc2==0)[0]]=True
#LumFuncErr2.mask[np.where(LumFunc2==0)[0]]=True
#LCBG_FIT4060_VOL=fit(LCBGFIT_init,LMBINAVE2.compressed(),LLumFunc2.compressed(),weights=1/LLumFuncErr2.compressed())
#LUMFUNC_FIT4060_VOL=fit(LCBGFIT_init,MBINAVE2.compressed(),LumFunc2.compressed(),weights=1/LumFuncErr2.compressed())
##f,axes=plt.subplots(nrows=2,ncols=1,sharex=True,gridspec_kw={'height_ratios':[3,1]})
...
galdensity=np.array([sp.integrate.quad(LUMFUNC_FIT020,-100,-18.5)[0],sp.integrate.quad(LUMFUNC_FIT2040,-100,-18.5)[0],sp.integrate.quad(LUMFUNC_FIT4060,-100,-18.5)[0],sp.integrate.quad(LUMFUNC_FIT6080,-100,-18.5)[0],sp.integrate.quad(LUMFUNC_FIT80100,-100,-18.5)[0],sp.integrate.quad(LUMFUNC_FIT3080,-100,-18.5)[0]])
...
FracGals=np.stack((redshiftrange,galdensity,lcbgdensity),axis=-1)
...
def schechter_fit(sample_M, phi=0.4*np.log(10)*0.00562, M_star=-20.85, alpha=-1.09, e=2.718281828):
	schechter = phi*(10**(0.4*(alpha+1)*(M_star-sample_M)))*(e**(-np.power(10,0.4*(M_star-sample_M))))
	return schechter


code=axes[0][0].errorbar(MBINAVE,np.log10(LumFunc),yerr=LogErr,fmt=',',label='1/V$_{MAX}$ code')
#code=axes[0][0].errorbar(MBINAVEz,LogLumFuncz,yerr=[LogErrzup,LogErrzdown],fmt=',',label='1/V$_{MAX}$ code')
gals=axes[1][0].bar(MBinMid,np.log10(NGal),Mbinsize,align='center',label='Number of Galaxies per Absolute Magnitude Bin',color='white')
axes[0][0].plot(LCBG_Range,np.log10(LUMFUNC_ZUCCA_FIT1035(LCBG_Range)),'-.',color='blue')
axes[0][0].plot(LCBG_Range,np.log10(schechter_fit(LCBG_Range)),'--',color='black')
plt.subplots_adjust(hspace=0,wspace=0)
axes[0][0].set_xticks(x)
axes[0][0].set_xticks(xminor,minor=True)
axes[0][0].set_yticks(y)
...
def schechter_fit(sample_M, phi=0.4*np.log(10)*0.0064, M_star=-20.67, alpha=-0.82, e=2.718281828):
	schechter = phi*(10**(0.4*(alpha+1)*(M_star-sample_M)))*(e**(-np.power(10,0.4*(M_star-sample_M))))
	return schechter

code=axes[0][1].errorbar(MBINAVE,np.log10(LumFunc),yerr=LogErr,fmt=',',label='1/V$_{MAX}$ code')
#code=axes[0][1].errorbar(MBINAVEz,LogLumFuncz,yerr=[LogErrzup,LogErrzdown],fmt=',',label='1/V$_{MAX}$ code')
gals=axes[1][1].bar(MBinMid,np.log10(NGal),Mbinsize,align='center',label='Number of Galaxies per Absolute Magnitude Bin',color='white')
axes[0][1].plot(LCBG_Range,np.log10(LUMFUNC_ZUCCA_FIT3555(LCBG_Range)),'-.',color='blue')
axes[0][1].plot(LCBG_Range,np.log10(schechter_fit(LCBG_Range)),'--',color='black')
autolabel(gals,'black',1,1)
plt.subplots_adjust(hspace=0,wspace=0)
...
def schechter_fit(sample_M, phi=0.4*np.log(10)*0.00659, M_star=-20.98, alpha=-0.85, e=2.718281828):
	schechter = phi*(10**(0.4*(alpha+1)*(M_star-sample_M)))*(e**(-np.power(10,0.4*(M_star-sample_M))))
	return schechter

code=axes[0][2].errorbar(MBINAVE,np.log10(LumFunc),yerr=LogErr,fmt=',',label='1/V$_{MAX}$ code')
#code=axes[0][2].errorbar(MBINAVEz,LogLumFuncz,yerr=[LogErrzup,LogErrzdown],fmt=',',label='1/V$_{MAX}$ code')
gals=axes[1][2].bar(MBinMid,np.log10(NGal),Mbinsize,align='center',label='Number of Galaxies per Absolute Magnitude Bin',color='white')
axes[0][2].plot(LCBG_Range,np.log10(LUMFUNC_ZUCCA_FIT5575(LCBG_Range)),'-.',color='blue')
axes[0][2].plot(LCBG_Range,np.log10(schechter_fit(LCBG_Range)),'--',color='black')
autolabel(gals,'black',1,2)
plt.subplots_adjust(hspace=0,wspace=0)
...
sfilein='/home/lrhunt/LUM_FUNC/FULLLFOUT/LF_ZUCCA_75_100.txt'
...
LumFunc2.mask[3]=True
MBINAVE2.mask[3]=True
LumFuncErr2.mask[3]=True
LogErrzdown[4]=0.312
...
def schechter_fit(sample_M, phi=0.4*np.log(10)*0.00432, M_star=-21.57, alpha=-1.59, e=2.718281828):
	schechter = phi*(10**(0.4*(alpha+1)*(M_star-sample_M)))*(e**(-np.power(10,0.4*(M_star-sample_M))))
	return schechter

code=axes[2][0].errorbar(MBINAVE,np.log10(LumFunc),yerr=LogErr,fmt=',',label='1/V$_{MAX}$ code')
#code=axes[2][0].errorbar(MBINAVEz,LogLumFuncz,yerr=[LogErrzup,LogErrzdown],fmt=',',label='1/V$_{MAX}$ code')
gals=axes[3][0].bar(MBinMid,np.log10(NGal),Mbinsize,align='center',label='Number of Galaxies per Absolute Magnitude Bin',color='white')
axes[2][0].plot(LCBG_Range,np.log10(LUMFUNC_ZUCCA_FIT75100(LCBG_Range)),'-.',color='blue')
axes[2][0].plot(LCBG_Range,np.log10(schechter_fit(LCBG_Range)),'--',color='black')
autolabel(gals,'black',3,0)
plt.subplots_adjust(hspace=0,wspace=0)
...
code=axes[2][1].errorbar(MBINAVE,np.log10(LumFunc),yerr=LogErr,fmt=',',label='1/V$_{MAX}$ code')
#code=axes[2][1].errorbar(MBINAVEz,LogLumFuncz,yerr=[LogErrzup,LogErrzdown],fmt=',',label='1/V$_{MAX}$ code')
gals=axes[3][1].bar(MBinMid,np.log10(NGal),Mbinsize,align='center',label='Number of Galaxies per Absolute Magnitude Bin',color='white')
axes[2][1].plot(LCBG_Range,np.log10(LUMFUNC_ZUCCA_FIT3080(LCBG_Range)),'-.',color='blue')
axes[2][1].plot(LCBG_Range,np.log10(schechter_fit(LCBG_Range)),'--',color='black')
plt.subplots_adjust(hspace=0,wspace=0)
...
axes[3][1].set_yticklabels([])
axes[3][2].set_yticklabels([])
axes[0][0].text(-23.5,-1,'z=0.1-0.35',verticalalignment='center',fontsize=12)
axes[0][1].text(-23.5,-1,'z=0.35-0.55',verticalalignment='center',fontsize=12)
axes[0][2].text(-23.5,-1,'z=0.55-0.75',verticalalignment='center',fontsize=12)
axes[2][0].text(-23.5,-1,'z=0.75-1.0',verticalalignment='center',fontsize=12)
axes[2][1].text(-23.5,-1,'z=0.3-0.8',verticalalignment='center',fontsize=12)
f.text(0.52,0.05,'M$_{B}$-5log$_{10}$(h$_{70}$)',ha='center',va='center',fontsize=12)
f.text(0.05,0.7,'Log$_{10}$($\Phi_{M}$) ($h^{3}_{70}$ Mpc$^{-3}$ mag$^{-1}$)',ha='center',va='center',rotation='vertical',fontsize=12)
f.text(0.05,0.35,'Log$_{10}$($\Phi_{M}$) ($h^{3}_{70}$ Mpc$^{-3}$ mag$^{-1}$)',ha='center',va='center',rotation='vertical',fontsize=12)
f.text(0.05,0.55,'Log$_{10}$(N)',ha='center',va='center',rotation='vertical',fontsize=12)
f.text(0.05,0.15,'Log$_{10}$(N)',ha='center',va='center',rotation='vertical',fontsize=12)