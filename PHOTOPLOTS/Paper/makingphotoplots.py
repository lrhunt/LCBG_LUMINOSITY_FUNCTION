...
axes[0][0].plot(Vegabv[LCBGS[np.where((zbest[LCBGS]>0.01)&(zbest[LCBGS]<0.25))[0]]],VegaSBe[LCBGS[np.where((zbest[LCBGS]>0.01)&(zbest[LCBGS]<0.25))[0]]],marker='o',linestyle='none',markeredgecolor='blue',mfc='none',markersize=4,mew=0.1)
...
axes[0][0].text(0,19,'LCBGs',fontsize=10,color='blue')
...
axes[0][1].plot(Vegabv[LCBGS[np.where((zbest[LCBGS]>0.25)&(zbest[LCBGS]<0.5))[0]]],VegaSBe[LCBGS[np.where((zbest[LCBGS]>0.25)&(zbest[LCBGS]<0.5))[0]]],marker='o',linestyle='none',markeredgecolor='blue',mfc='none',markersize=4,mew=0.1)
plt.subplots_adjust(hspace=0,wspace=0)
axes[0][1].plot(bvx,bvy,'b')
axes[0][1].plot(SBx,SBy,'b')
#axes[0][1].fill_between(bvx,21,16,facecolor='blue',alpha=0.1)
axes[0][1].text(0,19,'LCBGs',fontsize=10,color='blue')
...
axes[1][0].plot(Vegabv[LCBGS[np.where((zbest[LCBGS]>0.5)&(zbest[LCBGS]<0.75))[0]]],VegaSBe[LCBGS[np.where((zbest[LCBGS]>0.5)&(zbest[LCBGS]<0.75))[0]]],marker='o',linestyle='none',markeredgecolor='blue',mfc='none',markersize=4,mew=0.1)
axes[1][0].plot(bvx,bvy,'b')
axes[1][0].plot(SBx,SBy,'b')
#axes[1][0].fill_between(bvx,21,16,facecolor='blue',alpha=0.1)
axes[1][0].text(0,19,'LCBGs',fontsize=10,color='blue')
...
axes[1][1].plot(Vegabv[LCBGS[np.where((zbest[LCBGS]>0.75)&(zbest[LCBGS]<1))[0]]],VegaSBe[LCBGS[np.where((zbest[LCBGS]>0.75)&(zbest[LCBGS]<1))[0]]],marker='o',linestyle='none',markeredgecolor='blue',mfc='none',markersize=4,mew=0.1)
axes[1][1].plot(bvx,bvy,'b')
axes[1][1].plot(SBx,SBy,'b')
axes[1][1].text(0,19,'LCBGs',fontsize=10,color='blue')
...
f.text(0.07,0.5,'$\mu_{e}$(B)$_{0}$',ha='center',va='center',rotation='vertical')
